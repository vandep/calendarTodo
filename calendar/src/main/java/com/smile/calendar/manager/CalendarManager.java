...
public class CalendarManager {
    ...
    private OnMonthChangeListener monthChangeListener;//月份切换
    ...
    public interface OnMonthChangeListener {
        ...
        void weekChange(String week, LocalDate mSelected);
    }
    ...
    public void weekChanged() {
        monthStr = formatter.getHeaderText(mUnit.getType(), mUnit.getFrom(), mUnit.getTo(), mSelected);
        monthChangeListener.weekChange(monthStr, mSelected);
    }
    ...
    public LocalDate getUnitToday() {
        return mUnit.getToday();
    }*/
