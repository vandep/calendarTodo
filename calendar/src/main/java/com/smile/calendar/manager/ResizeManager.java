...
public class ResizeManager {
    ...
    private boolean withWeekMonthChanged;//是否需要月周切换

    public ResizeManager(@NonNull CollapseCalendarView calendarView, boolean withWeekMonthChanged) {
        mCalendarView = calendarView;
        this.withWeekMonthChanged = withWeekMonthChanged;
