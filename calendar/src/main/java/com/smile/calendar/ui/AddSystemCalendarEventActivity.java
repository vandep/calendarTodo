...
public class AddSystemCalendarEventActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (CalendarUtils.requestPermission(this)) {
            getCalendarEvent(2020, 1);
        }
        findViewById(R.id.add_calendar).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void writeCalendar() {
        ...
        if (CalendarUtils.requestPermission(this)) {
            ...
            long start = mCalendar.getTime().getTime() + 15 * 24 * 60 * 60 * 1000;
            mCalendar.set(Calendar.HOUR_OF_DAY, 11);
            long end = mCalendar.getTime().getTime() +   15 * 24 * 60 * 60 * 1000;
