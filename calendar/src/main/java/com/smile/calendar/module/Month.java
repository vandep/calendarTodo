...
public class Month extends RangeUnit {
    ...
    public Month(@NonNull LocalDate date, @NonNull LocalDate today, @Nullable LocalDate minDate,
    ...
    @Nullable
    @Override
    public LocalDate getFirstDateOfCurrentMonth(@NonNull LocalDate currentMonth) {
